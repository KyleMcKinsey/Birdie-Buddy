...
# -------------------------------------------------------------
# CURATED YOUTUBE VIDEO DIRECTORY (REPLACE WITH YOUR PREFERRED LINKS)
# -------------------------------------------------------------
VID_FULL_SWING   = "https://www.youtube.com/watch?v=1x_sA9Rk_9E"
VID_ALIGNMENT    = "https://www.youtube.com/watch?v=0kO1OToM8v0"
VID_SHORT_GAME   = "https://www.youtube.com/watch?v=QxIu3Lq_wXU"
VID_BUNKER_SAND  = "https://www.youtube.com/watch?v=GkXG8E8aO6Q"
VID_PUTTING      = "https://www.youtube.com/watch?v=eYk1U_-M69A"
...
DRILL_SCHEMATICS = {
    ...
    "Trail-Hand Push Putting Drill": {
        ...
        "analogy": " bowling **Bowling Roll:** Smooth single-arm rolling action down lane center without hooking wrist.",
...
if "diagnosis" in st.session_state and "confirmed_resources" in st.session_state:
    ...
    # Render Active Drills with Playable YouTube Video Embeds
