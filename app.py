...
# --- SIDEBAR: MANUAL API KEY & HISTORY EXPORTER ---
...
if not df_history.empty:
    ...
    st.sidebar.caption(
        "No session history recorded yet. Complete a round diagnosis and click"
        " 'Confirm Selection & Generate Execution Plan' to log your plan!"
    )
...
PERSONA_DATABASE = {
    "Bogey-Wan Kenobi (Jedi Master of Swing)": {
        "description": "Wise Jedi mentor guiding you away from the Dark Side using the Force of swing tempo.",
        "system_instruction": """
    ...
    "Captain Hack Sparrow (Pirate of the Fairway)": {
        "description": "Eccentric pirate caddie stumbling through hazards with chaotic strategies.",
        "system_instruction": """
...
DRILL_SCHEMATICS = {
    ...
    "Pause at Top Drill": {
        ...
        "vivid_description": "Take a full backswing and pause for a complete 2-second count at the top before starting your downswing.",
    ...
    "Tee Gate Drill": {
        ...
        "vivid_description": "Plant two tees just outside the toe and heel of your clubhead at address to force center-face contact.",
    ...
    "Towel Under Armpits Drill": {
        ...
        "vivid_description": "Tuck a single golf towel across your chest under both armpits. Take smooth half-swings without dropping the towel.",
    ...
    "Coin Strike Low-Point Drill": {
        ...
        "vivid_description": "Place a coin 2 inches ahead of your golf ball. Focus entirely on clipping the coin off the turf.",
    ...
    "Split-Hands Release Drill": {
        ...
        "vivid_description": "Separate your trail hand 3 inches down the grip like holding a hockey stick to feel forearm rotation.",
    ...
    "Feet-Together Balance Drill": {
        ...
        "vivid_description": "Stand with your feet touching heel-to-toe. Make smooth 75% tempo swings while maintaining total balance.",
    ...
    "Wall-Head Posture Drill": {
        ...
        "vivid_description": "Set up with your forehead gently touching a wall or soft pad to eliminate early extension.",
    ...
    "Impact Bag Compression Drill": {
        ...
        "vivid_description": "Swing half-speed into an impact bag, stopping at impact to feel shaft lean forward.",
    ...
    "Two-Step Pump Lag Drill": {
        ...
        "vivid_description": "Take a backswing, pump the downswing halfway down twice holding wrist angle, then sweep through.",
    ...
    "Towel Behind Ball Drill": {
        "equipment": "1 Microfiber Golf Towel",
        "vivid_description": "Lay a folded towel flat on the grass 4 inches behind the ball. Chip over the towel without clipping fabric.",
        "analogy": "Steep Landing Descent: Force the wedge sole to enter the turf right at the ball.",
    ...
    "Lead Foot Weight Anchor Drill": {
        ...
        "vivid_description": "Lift your trail heel off the ground so only your lead foot bears weight during chipping strokes.",
        "analogy": "Heavy Anchor: Keeps your swing center firmly ahead of the ball.",
    ...
    "Brush Turf Chipping Drill": {
        ...
        "vivid_description": "Take practice strokes without a ball, focusing on making a crisp 'thump' sound against the grass.",
        "analogy": "Broom Sweep: Sweep grass roots smoothly rather than digging deep trenches.",
        "pro_tip": "🏆 **Pro Tip:** Keep your chest moving toward the target through impact.",
    },
    "Coin Lead-Point Pitch Drill": {
        "equipment": "1 Quarter or Ball Marker",
        "vivid_description": "Place a coin flat under your golf ball. Slide the wedge bounce cleanly beneath the coin.",
        "analogy": "Credit Card Slide: Slide the rounded bottom of the club flat along the dirt surface.",
        "pro_tip": "🏆 **Pro Tip:** Keep trail wrist bent back softly through impact.",
    },
    "Ruler in Glove Wrist Anchor Drill": {
        "equipment": "1 Plastic Ruler, Golf Glove",
        "vivid_description": "Tuck a 6-inch plastic ruler into the back of your lead wrist glove to prevent wrist flipping.",
        "analogy": "Rigid Wrist Shield: Locks the lead wrist in a flat, stable structure.",
        "pro_tip": "🏆 **Pro Tip:** Drive the motion entirely with torso rotation.",
    },
    "Hinge-and-Hold Chipping Drill": {
        "equipment": "52° or 56° Wedge",
        "vivid_description": "Hinge your wrists quickly on the takeaway, then hold that wrist angle firm through impact.",
    ...
    "Clock System Wedge Drill": {
        ...
        "vivid_description": "Practice swing lengths mapped to clock hands: 7:30, 9:00, and 10:30. Record carry distances.",
        "analogy": "Precision Dial: Control distance with arm swing length rather than changing speed.",
    ...
    "Landing Zone Target Towel Drill": {
        ...
        "vivid_description": "Lay a small towel 15-20 yards out on the green. Focus 100% on landing pitch shots on the towel.",
        "analogy": "Bullseye Landing Pad: Land the ball exclusively on your designated spot.",
        "pro_tip": "🏆 **Pro Tip:** Walk up to the green beforehand to pick your exact landing spot.",
    },
    "Trail-Hand Only Pitch Drill": {
        "equipment": "Sand Wedge",
        "vivid_description": "Remove your lead hand and pitch balls using only your trail hand.",
        "analogy": "Underhand Ball Toss: Replicate the natural motion of tossing a tennis ball underhand.",
        "pro_tip": "🏆 **Pro Tip:** Allow the clubhead bounce to slap the turf softly.",
    },
    "Line in the Sand Drill": {
        "equipment": "Sand Wedge, Practice Bunker",
        "vivid_description": "Draw a line in the bunker sand. Practice swinging to make divots that start precisely on the line.",
        "analogy": "Erasing the Line: Train low-point control so the wedge enters sand 2 inches behind the ball.",
        "pro_tip": "🏆 **Pro Tip:** Accelerate fully through sand; never slow down near impact.",
    },
    "Dollar Bill Sand Extraction Drill": {
        "equipment": "Sand Wedge, Paper Bill",
        "vivid_description": "Place a ball on top of a dollar bill in the bunker. Aim to splash out the entire dollar-bill-sized patch of sand.",
        "analogy": "Sand Cushion Pillow: The club lifts the cushion of sand beneath the ball.",
        "pro_tip": "🏆 **Pro Tip:** Open the clubface fully before establishing your grip.",
    },
    "Open-Face Sand Splash Drill": {
        "equipment": "Lob Wedge (60°)",
        "vivid_description": "Lay the clubface flat to the sky in setup, lower your posture, and splash sand aggressively.",
        "analogy": "Pancake Flip: Slide the flat back of the wedge under sand.",
        "pro_tip": "🏆 **Pro Tip:** Lower your stance height by flexing knees wider.",
    },
    "Continuous Motion Pendulum Chipping Drill": {
        "equipment": "Pitching Wedge",
        "vivid_description": "Swing the wedge back and forth continuously over grass without stopping.",
        "analogy": "Grandfather Pendulum: Unbroken rhythm eradicates flinching.",
        "pro_tip": "🏆 **Pro Tip:** Focus on smooth breathing: exhale softly through impact.",
    },
    "Accelerating Through Impact Gate Drill": {
        "equipment": "2 Golf Tees, Wedge",
        "vivid_description": "Place a tee 6 inches behind the ball and another 12 inches ahead. Accelerate clean through both.",
    ...
    "Target-Focused Eyes-Up Chipping Drill": {
        "equipment": "56° Wedge",
        "vivid_description": "Look directly at your target flag instead of looking down at the ball during the chip stroke.",
        "analogy": "Free Throw Shooting: Basketball players look at the rim while shooting.",
    ...
    "Putting Tee Gate Drill": {
        ...
        "vivid_description": "Set two tees in green turf 3 feet ahead of putter, spaced wide enough for a ball to pass through.",
        "analogy": "Soccer Goal: Roll ball through center posts without touching either tee wall.",
        "pro_tip": "🏆 **Pro Tip:** Focus on keeping lead wrist flat to prevent face flaring.",
    },
    "Chalk Line Straight Target Drill": {
        "equipment": "Chalk Line Tool (10 Foot Line)",
        "vivid_description": "Snap a straight chalk line on a flat practice green. Roll putts staying perfectly aligned along line.",
    ...
    "Mirror Alignment Face Drill": {
        ...
        "vivid_description": "Place putter on reflective mirror tool. Ensure eye line sits directly over ball line.",
        "analogy": "Reflective Blueprint: Checks square shoulder and face positioning.",
        "pro_tip": "🏆 **Pro Tip:** Lead eye should hover directly over the center-back of the golf ball.",
    },
    "Trail-Hand Push Putting Drill": {
        "equipment": "Putter",
        "vivid_description": "Putt 5-footers using only your dominant trail hand. Extend smooth stroke along target line.",
        "analogy": "Bowling Roll: Smooth single-arm rolling action down lane center.",
    ...
    "Metal Yardstick Roll Drill": {
        ...
        "vivid_description": "Place ball on one end of metal yardstick. Stroke putts so ball stays on track across full length.",
        "analogy": "Tightrope Walk: Off-center strikes tumble ball off edge instantly within 6 inches.",
    ...
    "Parallel Rod Putting Channel Drill": {
        ...
        "vivid_description": "Set two rods parallel on green slightly wider than putter head width, creating a physical channel.",
        "analogy": "Bob Sled Track: Prevents path from coming inside or pulling left.",
    ...
    "Ladder Distance Lag Drill": {
        ...
        "vivid_description": "Set tees at 10, 20, 30, and 40 feet. Roll putts into each zone sequentially.",
        "analogy": "Climbing Rungs: Build instinctive muscular memory for backswing length vs roll distance.",
        "pro_tip": "🏆 **Pro Tip:** Hold finish stance until ball completely stops rolling.",
    },
    "Fringe-to-Fringe Feel Drill": {
        "equipment": "Putter",
        "vivid_description": "Putt across full green width targeting green fringe boundary. Stop ball within 6 inches of edge.",
    ...
    "Eyes-Closed Distance Perception Drill": {
        "equipment": "Putter",
        "vivid_description": "Look at hole target 20 feet away, close eyes, stroke putt, and call out 'short', 'long', or 'good'.",
    ...
    "Rubber Band Putter Sweet-Spot Drill": {
        ...
        "analogy": "Sweet Spot Pinpoint: Off-center strikes bounce dead off rubber bands.",
    ...
    "Two-Tee Putter Gate Drill": {
        ...
        "vivid_description": "Set tees in turf just wide enough for putter head toe and heel to swing through at address.",
    ...
    "Coin Balance Putter Back Drill": {
        ...
        "vivid_description": "Balance a coin on flat top surface of putter head during stroke without letting it slide off.",
        "analogy": "Balanced Tray: Demands smooth acceleration without jerky wrist twitching.",
        "pro_tip": "🏆 **Pro Tip:** Maintains smooth acceleration profile from backswing transition.",
    },
    "Push-Putting No-Backswing Drill": {
        "equipment": "Putter",
        "vivid_description": "Place putter against back of ball with zero backswing. Push ball forward smoothly into hole from 4 feet.",
    ...
    "Short Back Long Through Stroke Drill": {
        ...
        "analogy": "Pendulum Acceleration: Accelerates continuously through impact zone.",
        "pro_tip": "🏆 **Pro Tip:** Deceleration is the #1 cause of directional misses on short putts.",
    },
    "Coin Balance Motion Stroke Drill": {
        "equipment": "1 Quarter",
        "vivid_description": "Place quarter on grass 1 inch behind ball. Sweep putter sole smoothly over coin without touching.",
    ...
    "1-2-3 Box Breathing Reset Drill": {
        ...
        "vivid_description": "Inhale for 4s, hold for 4s, exhale for 4s before stepping into pre-shot setup to lower heart rate.",
        "analogy": "System Reboot Button: Clears mental noise and anxiety before entering execution area.",
        "pro_tip": "🏆 **Pro Tip:** Exhale fully through your nose right before placing clubface behind the ball.",
    },
    "Post-Shot Acceptance Hold Drill": {
        "equipment": "Golf Club, 3-Second Count",
        "vivid_description": "Hold finish pose for 3 full seconds post-impact regardless of ball flight with zero emotional outburst.",
        "analogy": "Neutral Journalist: Document ball flight as unbiased data rather than self-judgment.",
        "pro_tip": "🏆 **Pro Tip:** Smile or take a deep exhale as soon as your 3-second hold finishes.",
    },
    "Positive Box Pre-Shot Routine Drill": {
        "equipment": "1 Alignment Rod or Line on Ground",
        "vivid_description": "Calculate options in 'Think Box', then step into 'Play Box' with 100% commitment and zero swing thoughts.",
        "analogy": "Crossing into Boxing Ring: Make decisions outside ring; inside ring is pure execution.",
        "pro_tip": "🏆 **Pro Tip:** If a doubt enters your mind inside Play Box, step back behind the line.",
    },
    "Target Visual Anchoring Drill": {
        "equipment": "Target Flag / Specific Micro-Target",
        "vivid_description": "Pick a micro-target (e.g., specific leaf behind flag). Lock eyes onto it for 3 seconds before looking down.",
        "analogy": "Sniper Crosshairs: Aim at a thread, hit a button; aim at a house, miss the neighborhood.",
        "pro_tip": "🏆 **Pro Tip:** Keep vivid image of micro-target in mind's eye during backswing.",
    },
    "Mantra & Thought Neutralizer Drill": {
        "equipment": "Personal 2-Word Cue",
        "vivid_description": "Repeat a rhythmic two-word cadence (e.g., 'Smooth... Turn...') quietly during stroke.",
        "analogy": "Noise-Canceling Headphones: Block out intrusive internal doubt and fear.",
        "pro_tip": "🏆 **Pro Tip:** Sync rhythm so word 1 is backswing start and word 2 is impact release.",
    },
}
...
if st.session_state["diag_step"] == 1:
    ...
    st.caption(
        ...
        " feelings, mental blow-ups, or frustration."
    )
    ...
    user_round_story = st.text_area(
        ...
        placeholder=(
            ...
            " driver—everything kept slicing hard into the trees on the right..."
        ),
    )

    with st.expander("⚙️ Optional: Tweak Observable Selectors", expanded=False):
    ...
    if st.button(f"Analyze Round Narrative with {persona_display_name}", type="primary"):
        if not user_round_story.strip():
            ...
            Craft 2 targeted diagnostic decision-tree follow-up questions in persona voice.
...
# --- STEP 1B: TARGETED MULTI-CHOICE DECISION TREE ---
    ...
    q1_text = qs.get("question_1", "How do you react mentally after a bad hole?")
    q1_opts = qs.get("options_q1", ["I get angry and rush", "I overthink mechanics", "I stay calm"])

    q2_text = qs.get("question_2", "When you try to compensate, what happens next?")
    q2_opts = qs.get("options_q2", ["Contact gets fatter", "Ball loses distance", "Shot stays the same"])
    ...
    with col_btn1:
        if st.button("🔍 Synthesize Root Cause & Mindset Diagnosis", type="primary"):
            ...
            Analyze the round narrative through a **Strategic Game ROI ("Bang for Your Buck") Lens**:
            ...
            {{
              ...
              "primary_miss": "string",
              "primary_miss_persona": "string",
              "primary_cause_breakdown": "string",
...
if st.button("✅ Confirm Selection & Generate Execution Plan", type="primary"):
    ...
    # Save to CSV ONLY on explicit button click
    ...
    save_session_to_csv(
        ...
        secondary_miss=diag_data.get("secondary_miss", "N/A"),
        secondary_drill=diag_data.get("recommended_secondary_drill", "N/A"),
        practice_mode=practice_mode,
        total_balls=total_balls,
        total_time=total_time,
...
if "confirmed_resources" in st.session_state:
    ...
    st.progress(
        res_data["grind_pct"],
        text=f"Grind Mode: {int(res_data['grind_pct']*100)}% | Game Mode: {int(res_data['game_pct']*100)}%",
    )
...
if "diagnosis" in st.session_state and "confirmed_resources" in st.session_state:
    ...
    for idx, d_name in enumerate(active_drills):
        ...
        st.markdown(f"🔥 **{label}**")
        st.caption(f"⚡ `{balls_per_drill} Balls` | `{time_per_drill} Mins`")
    ...
    if gm_balls > 0 and gm_time > 0 and not is_pure_game:
        ...
        st.caption(f"⚡ `{gm_balls} Balls` | `{gm_time} Mins`")
